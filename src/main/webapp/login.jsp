        ...
        <div id="cd-login" class="is-visible is-selected"> <!-- log in form -->
            <form class="cd-form " action="${pageContext.request.contextPath}/login" method="post">
                <p class="fieldset">
                    ...
                    <input class="full-width has-padding has-border" id="username" type="text" name="username" placeholder="请输入账户名" value="">
                    <span class="cd-error-message">账户名错误</span>
                </p>
                <p class="fieldset">
                    <label class="image-replace cd-password" for="password">密码</label>
                    <input class="full-width has-padding has-border" id="password" type="password" name="password"  placeholder="请输入密码" value="">
                ...
                <p class="fieldset">
                    ...
                    <img id="captchaImg" src="${pageContext.request.contextPath}/captcha" onclick="changeImg()"style="vertical-align: bottom">
                </p>
                <p class="fieldset">
                    <input type="checkbox" id="remember-me" checked name="remember-me" value="true">
                    <label for="remember-me">记住密码</label>
                    <a href="/pages/movies_home.jsp">回到主页</a>
                </p>
                <p class="fieldset">
...
<script>
    ...
    function changeImg(){
        ...
        img.src="${pageContext.request.contextPath}/captcha?time="+time ;
