...
<div id="demo" class="carousel slide" data-ride="carousel" style="width: 100%; height: 520px;">
    ...
    <div class="carousel-inner" style="width: 100%; height: 100%;">
        <div class="carousel-item active" style="width: 100%; height: 100%;">
            <img src="${pageContext.request.contextPath}/static/image/黑豹.jpg" style="width: 100%; height: 100%;">
        </div>
        <div class="carousel-item">
            <img src="${pageContext.request.contextPath}/static/image/复联.jpg">
        </div>
        <div class="carousel-item">
            <img src="${pageContext.request.contextPath}/static/image/蜘蛛侠.jpg">
        </div>
    </div>
